            ...
            <AccordionContent>
                <FormField control={form.control} name="summary" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormMessage />
                    <Button type="button" size="sm" variant="outline" className="mt-2" onClick={() => handleImproveContent('summary', field.value || '')} disabled={isImproving}>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <FormField control={form.control} name={`experience.${index}.description`} render={({ field: descriptionField }) => (
                        <FormItem>
                          ...
                          <FormMessage />
                          <Button type="button" size="sm" variant="outline" className="mt-2" onClick={() => handleImproveContent(`experience.${index}.description`, descriptionField.value || '')} disabled={isImproving}>
